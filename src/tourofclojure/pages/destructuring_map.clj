...
(defn desc
  ...
  (condp = lang
    "fr" [:div
          ...
          [:p "En Clojure, vous pouvez aussi destructurer des map."]
          ...
          [:p "Comme pour les Vector, " [:b ":as"] " permet de récupérer la"
           " valeur complète d'une map déstructurée. Vous pouvez bien sûr également"
           " utiliser le destructuring sur des map imbriquées."]
